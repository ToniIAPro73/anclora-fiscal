...
describe('ShopifyOrderTransactionsCard', () => {
  it('muestra pedido, ID interno, comprador, tipo, estado, importe y fecha antes de confirmar', async () => {
    vi.stubGlobal('fetch', vi.fn().mockResolvedValue({ ok: true, status: 200, json: async () => ({
      ...
      shopifyOrderTransactions: { events: [{ shopifyOrderId: '9001', shopifyOrderName: 'AI-1001', customerName: 'Ana García', customerEmail: 'ana@example.test', kind: 'refund', status: 'success', amount: '-6.99', currency: 'EUR', occurredAt: '2026-07-02T10:00:00.000Z' }] },
    }) }));
