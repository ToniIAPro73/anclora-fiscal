...
export const permissions = {
  ADMIN: ['*'],
  FISCAL_OPERATOR: ['imports:write', 'operations:write', 'operations:read', 'events:read', 'reconciliation:read', 'reconciliation:write', 'issues:read', 'documents:issue', 'documents:read', 'periods:read', 'dossier:read', 'dashboard:read'],
